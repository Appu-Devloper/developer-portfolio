  ...
  void fetchProjects() {
    _projects = [
      ProjectItem(
        ...
        buttons: {
          "Android":
              "https://play.google.com/store/apps/details?id=com.vn.vishwanandini",
      ...
      ProjectItem(
        ...
        buttons: {
          "GitHub Repository":
              "https://github.com/Appu-Devloper/website_template.git",
        },
        isPrivate: true,
      ),
      ...
      ProjectItem(
        ...
        buttons: {
          "GitHub Repository":
              "https://github.com/Appu-Devloper/Ayurvedic_chatBot.git",
        },
        isPrivate: false,
      ),
      ...
      ProjectItem(
        ...
        buttons: {
          "GitHub Repository":
              "https://github.com/Appu-Devloper/attendance_app_google_script.git",
        },
        isPrivate: true,
      ),
      ProjectItem(
        ...
        buttons: {
          "GitHub Repository":
              "https://github.com/Appu-Devloper/UPSC_ASPIRANT.git",
        },
        isPrivate: false,
      ),
      ProjectItem(
        ...
        buttons: {"Visit GitHub": "https://github.com/Appu-Devloper"},
        isPrivate: false,
      ),
    ];
