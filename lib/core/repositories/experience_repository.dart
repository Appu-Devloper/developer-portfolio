...
class ExperienceProvider with ChangeNotifier {
  final List<SectionItem> _experienceList = [
    SectionItem(
      ...
      description:
          "Developed scalable software solutions to meet business needs, ensuring high performance and maintainability.\n"
    ...
    SectionItem(
      ...
      description:
          "Built high-performance cross-platform applications with Flutter, surpassing 5,000+ downloads.\n"
